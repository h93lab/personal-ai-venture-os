...
function Discovery() {
  ...
  const configureSchedule = trpc.discovery.configureSchedule.useMutation({ onSuccess: (data) => { void settings.refetch(); toast.success(data.enabled ? "تم تفعيل المسح اليومي الساعة 08:00 UTC" : "تم إيقاف المسح اليومي"); }, onError: (error) => toast.error(`تعذر إعداد الجدولة: ${error.message}`) });
